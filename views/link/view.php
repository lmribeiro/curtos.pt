                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="float-lg-right">
                                    <?= Html::tag('span', Html::a('<i class="fas fa-calendar-plus"></i> '.Yii::t('app', 'Renovar data de expiração'), '#', ['class' => 'btn btn-success btn-sm  btn-renew', 'data-id' => $model->id, 'data-toggle' => 'modal', 'data-target' => '#renew_modal'])); ?>
